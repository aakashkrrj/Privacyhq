    ...
    <div class="card-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-3 col-md-6">
                <button onclick="alert('Coming Soon: Feature under development.');" class="btn btn-primary w-100 py-3">
            ...
            <div class="col-lg-3 col-md-6">
                <button onclick="alert('Coming Soon: Feature under development.');" class="btn btn-success w-100 py-3">
            ...
            <div class="col-lg-3 col-md-6">
                <button onclick="alert('Coming Soon: Feature under development.');" class="btn btn-info text-white w-100 py-3">
